...
public class CardBagSettingActivity extends BaseActivity<CardBagDetailPresenter> implements ICardBagDetailView {
    ...
    protected int getLayoutId() {
        return R.layout.activity_card_bag_setting;
    }
